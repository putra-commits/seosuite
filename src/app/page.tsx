...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090b10] text-white selection:bg-yellow-500/30">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 border-b border-white/5 bg-[#090b10]/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-8 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-10">
            ...
            <Link href="/dashboard" className="px-6 py-2 rounded-full bg-zinc-900 border border-zinc-800 text-xs font-black uppercase tracking-widest hover:border-yellow-500/50 hover:text-yellow-500 transition-all">
              Dashboard
            </Link>
          </div>
        </div>
      ...
      <section className="relative pt-48 pb-32 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="max-w-6xl mx-auto px-8 relative z-10 text-center">
          ...
          >
            Banyak orang punya website tapi <span className="text-white italic">cuma jadi pajangan</span>. Masukkan URL Anda di bawah ini dan biarkan AI kami menemukan <span className="text-yellow-500">kebocoran trafik</span> Anda secara instan.
          </motion.p>
            ...
            {testState === "idle" && (
              <form onSubmit={handleTestWebsite} className="flex flex-col sm:flex-row gap-4 p-2 bg-zinc-900/50 border border-zinc-800 rounded-2xl backdrop-blur-xl">
                <input 
                  ...
                  required
                />
                <button type="submit" className="px-8 py-4 rounded-xl bg-gradient-to-r from-yellow-500 to-amber-600 text-black font-black uppercase tracking-widest hover:opacity-90 transition-opacity flex items-center justify-center gap-2">
            ...
            {testState === "scanning" && (
              <div className="p-12 bg-zinc-900/50 border border-zinc-800 rounded-3xl backdrop-blur-xl flex flex-col items-center justify-center gap-6">
                ...
                <div className="space-y-2 text-center">
                  <h3 className="text-xl font-black text-white italic animate-pulse">Menganalisis Arsitektur SEO...</h3>
                  <p className="text-sm font-bold text-zinc-500">Memeriksa kebocoran trafik dan indeks AI (ChatGPT/Perplexity).</p>
                </div>
              </div>
            )}
            ...
            {testState === "result" && (
              <div className="p-8 bg-[#1a0f0f] border border-red-900/50 rounded-3xl backdrop-blur-xl text-left shadow-[0_0_50px_rgba(220,38,38,0.15)] animate-in fade-in zoom-in duration-500">
                <div className="flex items-start gap-6">
                  <div className="w-20 h-20 rounded-full bg-red-950 border border-red-900 flex items-center justify-center shrink-0">
                    <span className="text-3xl font-black text-red-500">35</span>
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      <AlertTriangle className="w-5 h-5 text-red-500" />
                      <h3 className="text-xl font-black text-red-500 uppercase tracking-widest">Kritis: Otoritas Rendah</h3>
                    </div>
                    <p className="text-zinc-300 font-medium leading-relaxed mb-4">
                    ...
                    <ul className="space-y-2 mb-6 text-sm font-bold text-zinc-500">
                ...
                <button 
                  ...
                  className="w-full py-5 rounded-2xl bg-gradient-to-r from-red-600 to-red-500 text-white font-black text-lg uppercase tracking-widest hover:opacity-90 transition-all shadow-[0_10px_30px_rgba(220,38,38,0.3)] animate-pulse"
                >
      ...
      <section id="features" className="py-32 border-t border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
          <div>
            <h2 className="text-xs font-black text-yellow-500 uppercase tracking-[0.4em] mb-6">Masalah Tersembunyi</h2>
          ...
          <div className="relative">
            <div className="p-8 rounded-[3rem] bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 shadow-2xl relative z-10">
               ...
               <div className="space-y-6">
                  <div className="p-6 rounded-2xl bg-black border border-zinc-800 group hover:border-yellow-500/50 transition-all">
                     <p className="text-xs font-black text-yellow-500 uppercase tracking-widest mb-2">Personal Branding</p>
                  ...
                  <div className="p-6 rounded-2xl bg-black border border-zinc-800 group hover:border-amber-500/50 transition-all">
                     <p className="text-xs font-black text-amber-500 uppercase tracking-widest mb-2">Pemilik Ecommerce</p>
      ...
      <section className="py-40 bg-[#050505] relative overflow-hidden border-t border-white/5">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-32">
            <div>
               <h2 className="text-xs font-black text-yellow-500 uppercase tracking-[0.4em] mb-6">Efisiensi Modal</h2>
               ...
               <p className="text-zinc-400 text-lg font-bold leading-relaxed mb-8">
                 Iklan berbayar (Paid Ads) adalah <span className="text-red-500">biaya variabel</span> yang hilang saat Anda berhenti membayar. SEO & AEO adalah <span className="text-yellow-500">aset modal</span> yang terus tumbuh dan menghasilkan profit secara eksponensial.
               </p>
               ...
               <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-6">
                     <div className="w-2 h-12 bg-yellow-500 shadow-[0_0_15px_rgba(234,179,8,0.5)]" />
                     <div>
            ...
            <div className="p-8 rounded-[3rem] bg-zinc-900/20 border border-zinc-800 relative h-[400px] flex items-end gap-4">
               ...
               <div className="flex-1 flex flex-col justify-end gap-1 h-full relative z-10">
                  ...
                  >
                     <span className="text-[10px] font-black text-yellow-400 -rotate-90">ORGANIK</span>
                  </motion.div>
               ...
               <div className="absolute top-10 left-10 p-4 bg-black/80 backdrop-blur border border-zinc-800 rounded-2xl">
                  <p className="text-[10px] font-black text-yellow-500 uppercase tracking-widest mb-1">Pertumbuhan Kumulatif</p>
      ...
      <section id="pricing" className="py-40 relative border-t border-white/5 bg-zinc-950/20">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-24">
            <h2 className="text-xs font-black text-yellow-500 uppercase tracking-[0.4em] mb-4">Arsitektur Harga</h2>
            ...
            {TIERS.map((tier, i) => (
              <motion.div
                ...
                className={`p-10 rounded-[3rem] bg-zinc-900/40 border transition-all relative group overflow-hidden ${
                  tier.popular ? 'border-yellow-500/50 shadow-[0_0_50px_rgba(234,179,8,0.1)]' : 'border-zinc-800 hover:border-zinc-700'
                }`}
              >
                {tier.popular && (
                  <div className="absolute top-0 right-0 px-6 py-2 bg-gradient-to-r from-yellow-500 to-amber-600 text-black text-[10px] font-black uppercase tracking-widest rounded-bl-2xl italic">
                    Paling Strategis
                  </div>
                )}
